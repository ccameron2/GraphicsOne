...
float4 main(NormalPixelShaderInput input) : SV_Target
{
	...
	//Scroll the texture back and forth
	offsetTexCoord = offsetTexCoord + sin(wiggle * 0.1);
	//*******************************************
	...
	textureNormal = textureNormal + sin(wiggle * 0.1);
	//textureNormal.rg = 0;
...
// Calculate lighting
	...
	//Tint the colour of the texture
	diffuseMaterialColour.g = pow(diffuseMaterialColour.g, 2);
